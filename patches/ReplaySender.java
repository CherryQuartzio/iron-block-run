...
public class ReplaySender {
    ...
    private Path lastWorldExtractPath = null;
    ...
    public synchronized void clearEpisodeState() {
        if (mode == Mode.OFF) {
            return;
        }
    ...
    public void loadWorldFromZip(String zipFile) {
        ...
        if (lastWorldExtractPath != null) {
            FileUtils.deleteQuietly(lastWorldExtractPath.toFile());
            lastWorldExtractPath = null;
        }
        ...
        lastWorldExtractPath = saveBasePath;
