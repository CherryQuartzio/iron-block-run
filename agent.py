...
class HorseRaceEnv(gym.Env):
    ...
    def compute_reward(
        ...
        elif "gold_block" in (grid[BLOCK_ABOVE_CENTER_BLOCK], grid[BLOCK_ABOVE_CENTER_BLOCK+1], grid[BLOCK_ABOVE_CENTER_BLOCK-1], grid[BLOCK_ABOVE_CENTER_BLOCK+3], grid[BLOCK_ABOVE_CENTER_BLOCK-3]):
